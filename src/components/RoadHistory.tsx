...
import { useRoadHistory } from '@/hooks/useRoads';
import Loading from '@/components/ui/Loading';

interface RoadHistoryProps {
  roadSlug: string;
}

export default function RoadHistory({ roadSlug }: RoadHistoryProps) {
  const [isExpanded, setIsExpanded] = useState(false);
  const { data: historyData, isLoading } = useRoadHistory(roadSlug, { enabled: isExpanded });
